const _CustomField = require("../../model/schema/customField.js");
const CustomField = _CustomField.default || _CustomField.CustomField || _CustomField;
const _RoleAccess = require('../../model/schema/roleAccess.js');
const RoleAccess = _RoleAccess.default || _RoleAccess.RoleAccess || _RoleAccess;
