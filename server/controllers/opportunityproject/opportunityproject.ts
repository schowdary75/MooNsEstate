const { generateObjectId } = require("../../db/sqlModelWrapper.js");
const OpportunityProject = require("../../model/schema/opportunityproject.js");
const propertyData = require("../../model/schema/property.js");
